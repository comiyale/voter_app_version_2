        ...
        <section class="row">
          <div class="col col-12">
            <div class="d-flex grow flex-wrap">
              ...
              <!---->
              <div class="ml-4">
                <div class="card-title font-weight-light">Federal Election</div>
              </div>
            </div>
          ...
          <div class="col-sm-12 col-md-4 col" v-for="item in elections" :key="item.candidatesId">
            <div
              ...
              v-bind:style="{color:'#03a9fc',fontWeight: '900',fontSize:'1.2em',textTransform: 'capitalize',float:'left'}"
            >
              <div
...
export default {
  ...
  data: function() {
    return {
      ...
      endpoint:
        store.state.urlStore.baseUrl + store.state.urlStore.getFederalElections,
